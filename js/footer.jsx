...
const Footer = ({ setPage }) => {
  ...
  const [subscribed, setSubscribed] = React.useState(false); const waNumber = useWhatsAppNumber();
...
const WhatsAppFloat = () => {
  ...
  const magRef = useMagnetic(0.4); const waNumber = useWhatsAppNumber(); if (!waNumber) return null;
  return (
    <a ref={magRef} href={"https://wa.me/"+waNumber+"?text=Hola, me interesa información sobre departamentos en capitaldepas.com"} target="_blank" rel="noreferrer"
